...
<div class="row">
    <div class="col-lg-8 col-md-6 col-12">
        ...
        <div class="small-box border">
            <div class="inner">
                <img class="img-md p-1" src="{{ asset('assets/dist/img/user2-160x160.jpg') }}" alt="">
                <h3 class="text-light">Selamat Datang, Nanda</h3>
                <span class="text-dark">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deleniti culpa sequi
                    veritatis commodi
    ...
    <div class="col-lg-6 col-md-6 col-12">
        ...
        <div class="small-box border ">
            <div class="inner">
                ...
                <span class="text-dark">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur mollitia odio
